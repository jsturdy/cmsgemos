...
void gem::hw::amc13::AMC13Manager::initializeAction()
{
  ...
  try {
    ...
    XCEPT_RAISE(gem::hw::managers::amc13::exception::HardwareProblem, msg.str());
  ...
  try {
    ...
    XCEPT_RAISE(gem::hw::managers::amc13::exception::HardwareProblem,std::string("Problem during preinit : ")+e.what());
  } catch (std::exception const& e) {
