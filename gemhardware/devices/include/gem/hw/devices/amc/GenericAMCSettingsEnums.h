...
namespace gem {
  ...
  typedef gem::hw::devices::AMCLinkSettings::LinkBitMasks  AMCLinkBitMasks;
  typedef gem::hw::devices::AMCLinkSettings::LinkBitShifts AMCLinkBitShifts;

  typedef gem::hw::devices::AMCSettings::TTCEncoding AMCTTCEncoding;
  typedef gem::hw::devices::AMCSettings::TTCCommand  AMCTTCCommand;
  typedef gem::hw::devices::AMCSettings::OHLinkCount AMCOHLinkCount;

  // typedef the enum for casting and access
  typedef gem::hw::devices::AMCLinkSettings::LinkBitMasks::ELinkBitMasks   AMCLinkBitMasksT;
  typedef gem::hw::devices::AMCLinkSettings::LinkBitShifts::ELinkBitShifts AMCLinkBitShiftsT;

  typedef gem::hw::devices::AMCSettings::TTCEncoding::ETTCEncoding AMCTTCEncodingT;
  typedef gem::hw::devices::AMCSettings::TTCCommand::ETTCCommand   AMCTTCCommandT;
  typedef gem::hw::devices::AMCSettings::OHLinkCount::EOHLinkCount AMCOHLinkCountT;
}  // namespace gem
